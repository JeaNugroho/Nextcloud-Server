...
class RequestHandlerController extends OCSController {
	 ...
	 * @return Http\DataResponse<Http::STATUS_OK, \stdClass, array<string, mixed>>
	 * @throws OCSException
	 */
	 ...
	 * @param string|null $shareWith ID of the user that receives the share
	 * @param int|null $remoteId ID of the remote
	 * @return Http\DataResponse<Http::STATUS_OK, array{token: string, remoteId: string}, array<string, mixed>>
	 ...
	 * @return Http\DataResponse<Http::STATUS_OK, array{remote: string, owner: string}, array<string, mixed>>
