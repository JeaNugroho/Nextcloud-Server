...
class MountPublicLinkController extends Controller {
	 ...
	 * @return JSONResponse<Http::STATUS_OK, array{remoteUrl: string}, array<string, mixed>>|JSONResponse<Http::STATUS_BAD_REQUEST, array{message: string}, array<string, mixed>>
