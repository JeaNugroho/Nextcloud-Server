...
class ThemingController extends Controller {
	 ...
	 * @return FileDisplayResponse<Http::STATUS_OK, array{}>|NotFoundResponse<array<string, mixed>>
	 * @throws NotPermittedException
	 *
	 * 200: Image returned
	 * 404: Image not found
	 ...
	 * @return DataDisplayResponse<Http::STATUS_OK, array{Content-Type: 'text/css'}>|NotFoundResponse<array<string, mixed>>
	 *
