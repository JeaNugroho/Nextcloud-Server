...
class TemplateController extends OCSController {
	 ...
	 *
	 * @return DataResponse<Http::STATUS_OK, array<FilesTemplateFileCreator>, array<string, mixed>>
	 */
	 ...
	 *
	 * @return DataResponse<Http::STATUS_OK, array{template_path: string, templates: array<FilesTemplateFileCreator>}, array{}>
