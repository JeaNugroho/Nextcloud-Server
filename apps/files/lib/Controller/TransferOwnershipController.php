...
class TransferOwnershipController extends OCSController {
	 ...
	 *
	 * @return DataResponse<Http::STATUS_OK|Http::STATUS_BAD_REQUEST|Http::STATUS_FORBIDDEN, \stdClass, array<string, mixed>>
	 *
	 ...
	 *
	 * @return DataResponse<Http::STATUS_OK|Http::STATUS_FORBIDDEN|Http::STATUS_NOT_FOUND, \stdClass, array<string, mixed>>
	 *
